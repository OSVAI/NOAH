...
__all__ = ['MobileNetV2', 'mobilenetv2_035', 'mobilenetv2_050', 'mobilenetv2_075', 'mobilenetv2_100']
...
class MobileNetV2(nn.Module):
    def __init__(self,
        ...
        # building classifier
        if use_noah:
            self.head = NOAH(self.last_channel, num_classes, key_ratio=key_ratio, head_num=head_num, dropout=dropout)
        else:
...
def mobilenetv2_035(**kwargs):
    return MobileNetV2(width_mult=0.35, **kwargs)
